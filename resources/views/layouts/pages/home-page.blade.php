...
<section>
    <img src="{{asset('img/home1.jpg')}}" alt="A Image" class="img1">
    <img src="{{asset('img/home4.jpg')}}" alt="A Image" class="img1">
    <img src="{{asset('img/home2.jpg')}}" alt="A Image" class="img1">
    <img src="{{asset('img/home3.jpg')}}" alt="A Image" class="img1">
</section>
@endsection
