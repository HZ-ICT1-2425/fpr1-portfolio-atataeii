<x-posts-layout title="Cisco systems">
    <link rel="stylesheet" href="{{ asset('css/blog-cisco-systems.css') }}">
    <section>
        <div class="h1">
    ...
    <div class="boxBlogSWC">
        <!--First Section-->
        <section>
            <img src="{{ asset('img/cisco-systems.jpg') }}" alt="Company Image" class="imgSWC">
            <div class="p2">
