<x-posts-layout title="Cloud connected">
    <link rel="stylesheet" href="{{ asset('css/blog-cloud-connected.css') }}">
    <section>
        <div class="h1">
    ...
    <div class="boxBlogFWC">
        <!--Second Section-->
        <section>
            <img src="{{ asset('img/cloud-connected.jpg') }}" alt="Company Image" class="imgFWC">
            <div class="p2">
